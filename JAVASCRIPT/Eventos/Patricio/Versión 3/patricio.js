...
//Delegación de eventos, añadir gestor de eventos en la tabla
...
function moverCelda(celda) {
    ...
    //Si se clica la celda vacía no se hace nada
...
//Función que intercambia la celda vacía por la clicada
